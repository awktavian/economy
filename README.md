...
`make proof` invokes `~/.claude/scripts/proof-report-refresh.sh --oneline` and
refreshes the single estate report. Read its `economy` row for current build,
coverage, declaration, and axiom-accounting results.
